...
<html>
    <head>
        ...
        <title>Add contestant page</title>
    ...
    <body>
        ...
        <div class="center">
            ...
            <form action="AddContestant" method="POST">
                ...
                <textarea id="manifesto" name="manifesto" type="text" class="form-control" rows="3"></textarea>
                ...
                <div class="submit-div">
                    ...
                    <a type="submit" class="btn btn-secondary" href="contestant.jsp">Cancel</a>
                </div>
