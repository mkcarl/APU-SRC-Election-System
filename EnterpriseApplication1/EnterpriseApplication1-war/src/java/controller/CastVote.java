 ...
 * @author munky
 */
@WebServlet(name = "CastVote", urlPatterns = {"/student/CastVote"})
public class CastVote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Seat candidate = seatFacade.find(candidateID);
        long now = new Date().getTime();
        
        
        Vote newVote = new Vote(login, candidate, now);
        
        voteFacade.create(newVote);
